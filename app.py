...
# UI auf Streamlit
st, tab1 = st.tabs(['Generator','weitere Optionen'])
st.title('Lotus Generator')
st.subheader('Monat / Ziele auswählen')
lotus_option = st.selectbox('Monat/Ziele',['Monat', 'Ziele'])
if lotus_option == 'Monat':
...
with tab1:
    schriftart = tab1.selectbox('Schriftart wählen',['Helvetica','Times'])